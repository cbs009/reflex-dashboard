...
def monthly_summary_table() -> rx.Component:
    return rx.box(
        ...
        rx.box(
            # HEADER ROW
            rx.flex(
                rx.box(rx.text("CHANNEL / REGION", font_weight="bold", color="gray.400", font_size="10px", letter_spacing="0.1em"), width="240px", min_width="240px", max_width="240px", padding_left="4", padding_y="3", border_right=f"1px solid {BORDER_COLOR}"),
                rx.foreach(
                    State.summary_table_columns,
                    lambda col: rx.flex(
                        rx.text(col, font_weight="bold", color="gray.400", font_size="10px", text_align="center", width="100%", letter_spacing="0.1em"),
                            ...
                            row.is_total,
                             ...
                             rx.flex(
                                ...
                                rx.foreach(
                                    ...
                                    rx.box(flex="1", bg="#000000", min_width="0px"), # Visual fix: fill remaining space with black
                                    ...
                                    rx.accordion.trigger(
                                        rx.flex(
                                            ...
                                            rx.foreach(
                                                ...
                                                rx.box(rx.text(row.total_value, font_weight="bold", color="white", font_size="10px", text_align="center"), width="140px", min_width="140px", max_width="140px", padding_y="3", overflow="hidden", bg="#000000"), 
                                            width="100%",
                                            align="center",
                                            bg="transparent",
...
def monthly_sales_return_table() -> rx.Component:
    return rx.box(
        ...
        rx.box(
            # HEADER ROW
            rx.flex(
                rx.box(rx.text("CHANNEL", font_weight="bold", color="gray.400", font_size="10px", letter_spacing="0.1em"), width="240px", min_width="240px", max_width="240px", padding_left="4", padding_y="3", border_right="1px solid rgba(255,255,255,0.05)"),
                rx.foreach(
                    State.summary_table_columns,
            ...
            rx.vstack(
                rx.foreach(
                    ...
                    lambda row: rx.box(
                         rx.flex(
                            rx.box(rx.text(row.channel, font_weight="bold", color=rx.cond(row.is_total, "white", "gray.300"), font_size="10px", text_transform="capitalize"), width="240px", min_width="240px", max_width="240px", padding_left="4", padding_y="3", border_right=f"1px solid {BORDER_COLOR}", overflow="hidden"),
                            rx.foreach(
                                row.monthly_values,
                                lambda m, i: rx.flex(
                                    rx.text(m.value, color=rx.cond(row.is_total, "white", "gray.400"), font_size="10px", text_align="center", width="100%", white_space="nowrap", text_overflow="ellipsis", overflow="hidden"),  
                                    width=MONTH_COL_WIDTH,
                                    min_width=MONTH_COL_WIDTH,
                                    max_width=MONTH_COL_WIDTH,
                                    flex="none", 
                                ...
                                rx.box(rx.text(row.total_value, font_weight="bold", color=rx.cond(row.is_total, "#22c55e", "white"), font_size=rx.cond(row.is_total, "sm", "10px"), text_align="center"), width="140px", min_width="140px", max_width="140px", padding_y="3", overflow="hidden", bg=rx.cond(row.is_total, "#000000", "#000000")),
    ...
    return rx.box(
        ...
        rx.box(
             ...
             rx.flex(
                 ...
                 rx.box(
                     rx.center(
                         rx.text("MONTH", font_weight="bold", color="gray.400", font_size="10px", letter_spacing="0.1em"),
                         height="100%",
                         width="100%"
                     ),
                 ...
                 rx.vstack(
                     ...
                     rx.flex(
                         rx.foreach(
                             ...
                             lambda col, i: rx.flex(
                                 rx.text(col, font_weight="bold", color="gray.400", font_size="10px", text_align="center", width="100%", letter_spacing="0.1em", text_transform="capitalize"),
                                 width="136px", 
                                 min_width="136px",
                                 flex="none", 
                                 padding_y="3", 
                     ...
                     rx.flex(
                         rx.foreach(
                             State.invoice_return_columns,
                             lambda col, i: rx.flex(
                                 rx.box(rx.text("Inv", color="gray.400", font_size="10px", font_weight="bold", text_align="center"), width=COL_WIDTH, border_right=f"1px solid {BORDER_COLOR}", padding_y="2"),
                                 rx.box(rx.text("Ret", color="#FA5252", font_size="10px", font_weight="bold", text_align="center"), width=COL_WIDTH, border_right=f"1px solid {BORDER_COLOR}", padding_y="2"),
                                 width="136px",
                                 min_width="136px",
                                 flex="none",
                                 justify="center",
                ...
                rx.vstack(
                    rx.flex(
                        rx.text("Grand Total", font_weight="bold", color="gray.400", font_size="10px", text_align="center", width="100%", letter_spacing="0.1em"),
                        width="136px", 
                        min_width="136px",
                        padding_y="3", 
                        border_right=f"1px solid {BORDER_COLOR}", 
                        ...
                        rx.cond(
                           row.is_pct,
                            ...
                            rx.foreach(
                                row.channels,
                                lambda chan, i: rx.flex(
                                    rx.box(rx.text(chan.inv, color=rx.cond(chan.channel=="Grand Total", "#22c55e", "white"), font_size="10px", text_align="center"), width=COL_WIDTH, border_right=f"1px solid {BORDER_COLOR}", padding_y="2"),
                                    rx.box(rx.text(chan.ret, color="#FA5252", font_size="10px", text_align="center"), width=COL_WIDTH, border_right=f"1px solid {BORDER_COLOR}", padding_y="2"),
                                    width="136px",
                                    min_width="136px",
                                    flex="none",
                                    justify="center",
