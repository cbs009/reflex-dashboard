...
from ..constants import ACCENT_INDIGO, CARD_BG, BORDER_COLOR

def ai_chat_component():
    return rx.box(
        rx.vstack(
            rx.heading("Ask AI Assistant", size="4", color=ACCENT_INDIGO, margin_bottom="2", width="100%", text_align="center"),
            rx.hstack(
                rx.input(
